...
<div class="crm-block crm-form-block crm-civirule-rule_condition-block-activity_campaign">
  ...
  <div class="crm-section sector-section">
    ...
    <div class="content crm-select-container" id="activity_campaign_block">
